...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot[firstcurvestyle, -{Kite}, domain=0:0.815538] {(sec(x*90)-1)};
    \addplot[firstcurvestyle, {Kite}-, domain=1.18446:2] {(-sec(x*90)-1)};
    \addplot[asymptote, -] coordinates {(1,-0.5) (1,2.5)};
    \addplot[soliddot] coordinates {(0,0) (2,0)};
  \end{axis}
\end{tikzpicture}
