...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot[firstcurvestyle, -{Kite}, domain=-1:2.99752475247525, samples=100] {1/((x-3)*(x-7)^(2))};
    \addplot[firstcurvestyle, {Kite}-{Kite}, domain=3.00247524752475:6.92928932188135, samples=100] {1/((x-3)*(x-7)^(2))};
    \addplot[firstcurvestyle, {Kite}-, domain=7.07071067811865:8, samples=100] {1/((x-3)*(x-7)^(2))};
    \addplot[asymptote,-] coordinates {(3,-50) (3,50)};
    \addplot[asymptote,-] coordinates {(7,-50) (7,50)};
  \end{axis}
\end{tikzpicture}
