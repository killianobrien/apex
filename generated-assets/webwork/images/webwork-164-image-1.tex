...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot[firstcurvestyle, -{Kite}, domain=-4:-2.14142135623731, samples=100] {-1/(x--2)^(2)};
    \addplot[firstcurvestyle, {Kite}-, domain=-1.85857864376269:1, samples=100] {-1/(x--2)^(2)};
    \addplot[asymptote,-] coordinates {(-2,-50) (-2,50)};
  \end{axis}
\end{tikzpicture}
