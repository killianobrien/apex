...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot[firstcurvestyle, -{Kite}, domain=0:0.893399] {(sec((x-0)/1*90)-1+4)};
    \addplot[firstcurvestyle, {Kite}-, domain=1.25638:3] {(sec((x-3)/(-2)*90)-1+5)};
    \addplot[asymptote, -] coordinates {(1,-1) (1,9)};
    \addplot[soliddot] coordinates {(0,4) (3,5)};
  \end{axis}
\end{tikzpicture}
