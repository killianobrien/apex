...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot[firstcurvestyle, -, domain=0:4] {(-0.25*(x-0)+1)};
    \addplot[firstcurvestyle, -, domain=4:5] {(0*(x-5)+4)};
    \addplot[soliddot] coordinates {(0,1) (4,4) (5,4)};
    \addplot[hollowdot] coordinates {(4,0)};
  \end{axis}
\end{tikzpicture}
