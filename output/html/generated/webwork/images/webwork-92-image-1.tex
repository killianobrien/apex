...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot[firstcurvestyle, -, domain=0:1] {(2*(x-0)+0)};
    \addplot[firstcurvestyle, -, domain=1:2] {(1*(x-1)^2+3)};
    \addplot[soliddot] coordinates {(0,0) (1,4) (2,4)};
    \addplot[hollowdot] coordinates {(1,3) (1,2)};
  \end{axis}
\end{tikzpicture}
