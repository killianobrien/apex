...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot[firstcurvestyle, -, domain=0:1] {(1*(x-0)+0)};
    \addplot[firstcurvestyle, -, domain=1:2] {(-2*(x-1)+2)};
    \addplot[hollowdot] coordinates {(1,1) (1,2)};
    \addplot[soliddot] coordinates {(0,0) (1, 2) (2,0)};
  \end{axis}
\end{tikzpicture}
