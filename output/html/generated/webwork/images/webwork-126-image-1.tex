...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot[firstcurvestyle, -, domain=-4:0] {(-2 + 4 + sin((x+2)*45) * (4--2))/2};
    \addplot[firstcurvestyle, -, domain=0:4] {(-2 + -2 - sin((x+2)*45) * (-2--2))/2};
    \addplot[hollowdot] coordinates {(0,-2)};
    \addplot[soliddot] coordinates {(-4,-2) (0,4) (4,-2)};
  \end{axis}
\end{tikzpicture}
