...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot[firstcurvestyle, -, domain=-4:0] {cos((x-0)/(-4-0)*180)*(-5-3)/2+(3+-5)/2};
    \addplot[firstcurvestyle, -, domain=0:5] {(cos((x-5)/(-5)*180)*1/2+1.5)};
    \addplot[soliddot] coordinates {(-4,3) (0,3) (5,2)};
    \addplot[hollowdot] coordinates {(0,-5) (0,1)};
  \end{axis}
\end{tikzpicture}
