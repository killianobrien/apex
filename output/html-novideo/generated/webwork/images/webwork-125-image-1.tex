...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot[firstcurvestyle, -, domain=0:1] {((x-0.5)*(x-1)*0/0.5+(x-0)*(x-1)*0.5/(-0.25)+(x-0)*(x-0.5)*1.5/0.5)};
    \addplot[firstcurvestyle, -, domain=1:2] {(0.5*(x-2)+2)};
    \addplot[soliddot] coordinates {(0,0) (2,2)};
  \end{axis}
\end{tikzpicture}
