...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot[firstcurvestyle, -, domain=0:1] {(1*(x-0)+1)};
    \addplot[firstcurvestyle, -, domain=1:2] {((x-1)*(x-1.5)*0/0.5+(x-1)*(x-2)*0.5/(-0.25)+(x-1.5)*(x-2)*2/0.5)};
    \addplot[soliddot] coordinates {(0,1) (1, 1) (2,0)};
    \addplot[hollowdot] coordinates {(1,2) (1,2)};
  \end{axis}
\end{tikzpicture}
